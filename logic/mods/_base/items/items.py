...
ITEM_STATS = {
    ...
    ITEM.SLIPPERS: ItemData(ICAT.BASIC, 75, {STAT.AIR: {VALUE.CURRENT: 12}, STAT.MANA: {VALUE.MAX_VALUE: 5}}),
    ...
    # Potions
    ITEM.HEART: ItemData(ICAT.POTION, 110, {STAT.HP: {VALUE.DELTA: 0.003, VALUE.MAX_VALUE: 30}}),
    ITEM.VIAL: ItemData(ICAT.POTION, 85, {STAT.MANA: {VALUE.DELTA: 0.002, VALUE.MAX_VALUE: 20}}),
    ITEM.GEM: ItemData(ICAT.POTION, 65, {STAT.WATER: {VALUE.CURRENT: 10}, STAT.HP: {VALUE.MAX_VALUE: 10}}),
    # Ornaments
